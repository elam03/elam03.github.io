...
Elm.BlogList.make = function (_elm) {
   ...
   var viewBlog = F2(function (address,blog) {
      ...
      var keywordContent = function () {
         ...
         A2($List.intersperse,
         ", ",
         A2($Maybe.withDefault,_U.list([]),blog.keywords)));
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([viewCurrBlog
              ...
              ,A2($Html.table,_U.list([classStyle]),blogs)]));
   });
   ...
   var update = F2(function (action,model) {
      ...
      {case "LoadBlogList": var blogs = function (_) {
         ...
         case "HoverBlog": return {ctor: "_Tuple2"
                                  ,_0: model
                                  ,_1: $Effects.none};
   ...
   var init = function (blogList) {
      return {ctor: "_Tuple2"
             ,_0: A5(Model,blogList,_U.list([]),$Html.text(""),"debug!",0)
