...
var _user$project$BlogList$Blog = F5(
	function (a, b, c, d, e) {
		return {title: a, id: b, date: c, keywords: d, url: e};
	});
var _user$project$BlogList$decodeBlog = A6(
						...
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									' currId: ',
									_elm_lang$core$Basics$toString(model.currId)))))
					])),
				A2(
...
var _user$project$Building$darkGrey = A4(_elm_lang$core$Color$rgba, 50, 50, 50, 0.6);
...
var _user$project$Building$clearGrey = A4(_elm_lang$core$Color$rgba, 111, 111, 111, 0.6);
...
var _user$project$ProjectList$viewProject = function (project) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('projectlist-item')
			]),
		content);
};
var _user$project$ProjectList$view = function (model) {
	var attributes = _elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('projectlist-table')
		]);
	var numCols = 3;
	var projects = A2(
		_user$project$Utils$composeTiledHtml,
...
var _user$project$SummaryList$viewSummary = function (summary) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('summarylist-item')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
...
var _user$project$SummaryList$getData = function (location) {
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$SummaryList$FetchFail,
